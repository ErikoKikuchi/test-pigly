...
<div class="weight-data">
    ...
    <div class="weight-record">
        <div class="weight-record__top-wrapper">
            <div class="weight-record__top">
                <form class="search-form" action="/weight_logs/search" method="get">@csrf
                    ...
                    <div class="close__search-item">
                        <a class="close__search-item--link" href="/weight_logs">リセット</a>
                    </div>
                    @endif
                </form>
                @if(!empty($date_from) || !empty($date_end))
                ...
                <div class="modal-content">
                    ...
                    <form class="weight-logs__create-form" action="/weight_logs/create" method="post">
                        ...
                        <div class="modal-content__date">
                            <div class="modal-content__label-wrapper">
                        ...
                        <div class="modal-content__exercise-content">
                            ...
                            <textarea class="modal-content__input-textarea" type="text" id="exercise_content" name="exercise_content" placeholder="運動内容を追加"></textarea>
                        </div>
                        <div class="error-message">
        ...
        <div class="weight-record__contents">
            <table class="weight-record__inner">
                <thead>
                    <tr class="weight-record__row--header">
